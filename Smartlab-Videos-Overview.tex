...
This document shows different activities done in the smartlab or the near ecosystem. 

A short overview is given intrinsically in the image-Video \glqq Eigene Ideen im Smartlab verwirklichen\grqq \- (s.a. Fig. \ref{Fig0} ) 


\href{https://www.youtube.com/embed/h5bxMwJhbHY}{"Eigene Ideen im Smartlab verwirklichen" \\ URL: https://www.youtube.com/embed/h5bxMwJhbHY}

Description: Image Video of the Smartlab

\begin{figure}
\includegraphics[scale=0.4]{img/Smartlab_Machine-Types.JPG} 
\caption{Smartlab - overview of machine - types}\label{Fig0}
\end{figure}

The document is divided in the following sections:
\begin{itemize}
\item Teaching Videos
\item Public Live Casts (in future - soob coming)
\item Project Videos (in future - soon coming)
\item Privatissimunm
\end{itemize}

\paragraph{Teaching Videos} describes the different machines in the smartlab.

\paragraph{Project Videos} contains videos regarding the individual projects done mostly by students in the smartlab.

\paragraph{Public Live Casts} contains videos that shall show in a live cast manner, activities or typical possible things that can be done in the smartlab by nearly everyone.

\paragraph{Privatissimun} contains the live workflow of the project work, which casually documents the student's project work in the smartlab and around.
...
\paragraph{Description:} This Project from Mr. Shi Yuhao is about a robot car that can be made in the smartlab. Several protototypes are made as well as as workshop to build it.

\href{https://youtu.be/fqgjylL5hfc}{"2018\_04\_25\_RobotCar\_EllipseandLine" URL:https://youtu.be/fqgjylL5hfc}  
...
Description: Experiment for the Triangulation with the FabsScan 100 - first live Cast in the smartlab (s.a. Fig. \ref{Fig1}).
\begin{itemize}
...
\caption{Smartlab - Privatissimum - Triangulation Tests - 23.4.2018 live cast}\label{Fig1}
\end{figure}
...
\section{2018\_04\_30\_SS18\_Privatissimum\_BII\_08}
\href{https://vc.fh-kaernten.at/ps5vgrnv711b/}{2018\_04\_30\_SS18\_Privatissimum\_BII\_08 \\ "Url: https://vc.fh-kaernten.at/ps5vgrnv711b/"}
